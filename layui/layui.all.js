...
! function(e) {
  ...
  r.prototype.cache = n, r.prototype.define = function(e, t) {
    ...
    if (v = v.replace(/^\{\/\}/, ""), !n.modules[d] && layui[d] && (n.modules[d] = v), n.modules[d]) ! function g() {
      return ++m > 1e3 * n.timeout / 4 ? a(d + " is not a valid module") : void("string" == typeof n.modules[d] &&
    ...
    if (t = t || "layui", r = r || localStorage, e.JSON && e.JSON.parse) {
      ...
      return "value" in n && (o[n.key] = n.value), n.remove && delete o[n.key], r[t] = JSON.stringify(o), n.key ? o[n
        .key] : o
    }
    ...
    return t ? (r.sort(function(e, n) {
      var r = /^-?\d+$/,
        o = e[t],
        a = n[t];
      return r.test(o) && (o = parseFloat(o)), r.test(a) && (a = parseFloat(a)), o && !a ? 1 : !o && a ? -1 : o >
        a ? 1 : o < a ? -1 : 0
    }), n && r.reverse(), r) : r
    ...
    return o ? (n.event[l] = n.event[l] || {}, n.event[l][c] = [o], this) : (layui.each(n.event[l], function(e, t) {
      return "{*}" === c ? void layui.each(t, s) : ("" === e && layui.each(t, s), void(c && e === c && layui.each(
        t, s)))
    }), i)
  }, e.layui = new r
}(window);
            ...
            var h = "string" == typeof r.attr("lay-search"),
              ...
              m = t(['<div class="' + (h ? "" : "layui-unselect ") + a, (u ? " layui-select-disabled" : "") +
                '">', '<div class="' + n + '">', '<input type="text" placeholder="' + p + '" ' + (
                  'value="' + (d ? f.html() : "") + '"') + (!u && h ? "" : " readonly") +
                ' class="layui-input' + (h ? "" : " layui-unselect") + (u ? " " + c : "") + '">',
...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function(e) {
  ...
  F.prototype.config = {
      ...
      if (a.elem = t(a.elem), a.where = a.where || {}, a.id = a.id || a.elem.attr("id") || e.index, a.request = t.extend({
        ...
        return e;
      a.height && /^full-\d+$/.test(a.height) && (e.fullHeightGap = a.height.split("-")[1], a.height = H.height() -
      ...
      var c = this,
        ...
        b = function() {
          ...
          return !r && c.sortKey ? c.sort(c.sortKey.field, c.sortKey.sort, !0) : (layui.each(y, function(a, l) {
                ...
                if (void 0 !== m && null !== m || (m = ""), !r.colGroup) {
                  var g = ['<td data-field="' + c + '" data-key="' + v + '" ' + function() {
                    ...
                    return r.edit && e.push('data-edit="' + r.edit + '"'), r.align && e.push(
                        'align="' + r.align + '"'), r.templet && e.push('data-content="' + m + '"'),
              ...
              }), v.push('<tr data-index="' + a + '">' + o.join("") + "</tr>"), m.push('<tr data-index="' +
                a + '">' + y.join("") + "</tr>"), g.push('<tr data-index="' + a + '">' + h.join("") +
                "</tr>"))
            }), c.layBody.scrollTop(0), c.layMain.find("." + p).remove(), c.layMain.find("tbody").html(v.join("")),
            c.layFixLeft.find("tbody").html(m.join("")), c.layFixRight.find("tbody").html(g.join("")), c.renderForm(),
      ...
      return d.cache[c.key] = y, c.layPage[0 == o || 0 === y.length && 1 == n ? "addClass" : "removeClass"](f), r ?
        b() : 0 === y.length ? (c.renderForm(), c.errorView(s.text.none)) : (c.layFixed.removeClass(f), b(), c.renderTotal(
          y, h), void(s.page && (s.page = t.extend({
        ...
        i.eachCols(function(e, o) {
          var r = o.field || e,
            ...
            c = ['<td data-field="' + r + '" data-key="' + a.index + "-" + o.key + '" ' + function() {
              var e = [];
              return o.align && e.push('align="' + o.align + '"'), o.style && e.push('style="' + o.style +
      ...
      i.layBody.on("change", "." + R, function() {
        ...
        if (!i.data("off") && a) {
          ...
          return n[0].value = i.data("content") || l.text(), i.find("." + R)[0] || i.append(n), n.focus(), void layui
            .stope(e)
        }
  ...
  var t = layui.$,
    i = {
      fixbar: function(e) {
        ...
        var c = [e.bar1, e.bar2, "&#xe604;"],
          u = t(['<ul class="' + a + '">', e.bar1 ? '<li class="layui-icon" lay-type="bar1" style="' + e.bgcolor +
            '">' + c[0] + "</li>" : "", e.bar2 ? '<li class="layui-icon" lay-type="bar2" style="' + e.bgcolor +
            '">' + c[1] + "</li>" : "", '<li class="layui-icon ' + o + '" lay-type="top" style="' + e.bgcolor +
            '">' + c[2] + "</li>", "</ul>"
          ].join("")),
          g = u.find("." + o),
          s = function() {
      ...
      timeAgo: function(e, t) {
        ...
        return a > 26784e5 ? (a = new Date(e), n[0][0] = i.digit(a.getFullYear(), 4), n[0][1] = i.digit(a.getMonth() +
          1), n[0][2] = i.digit(a.getDate()), t || (n[1][0] = i.digit(a.getHours()), n[1][1] = i.digit(a.getMinutes()),
          n[1][2] = i.digit(a.getSeconds())), n[0].join("-") + " " + n[1].join(":")) : a >= 864e5 ? (a / 1e3 /
          60 / 60 / 24 | 0) + "天前" : a >= 36e5 ? (a / 1e3 / 60 / 60 | 0) + "小时前" : a >= 18e4 ? (a / 1e3 / 60 |
          0) + "分钟前" : a < 0 ? "未来" : "刚刚"
      },
      digit: function(e, t) {
        var i = "";
      ...
      toDateString: function(e, t) {
        ...
        return t = t || "yyyy-MM-dd HH:mm:ss", t.replace(/yyyy/g, a[0]).replace(/MM/g, a[1]).replace(/dd/g, a[2])
      ...
      event: function(e, n, a) {
        var o = t("body");
        return a = a || "click", n = i.event[e] = t.extend(!0, i.event[e], n) || {}, i.event.UTIL_EVENT_CALLBACK =
          i.event.UTIL_EVENT_CALLBACK || {}, o.off(a, "*[" + e + "]", i.event.UTIL_EVENT_CALLBACK[e]), i.event.UTIL_EVENT_CALLBACK[
            e] = function() {
            var i = t(this),
              a = i.attr(e);
